...
namespace AdafruitMatrix {
    ...
    public class Adafruit8x8Matrix : Ht16K33, IDisposable {
        ...
        public Adafruit8x8Matrix(string name, ushort panels = 1) : base(Display.On) {
        ...
        public void FrameSet(int startPosition, int endPostion, bool state) {
            startPosition = startPosition < 0 ? 0 : startPosition;
            endPostion = endPostion > (Columns * Rows) ? (Columns * Rows) : endPostion;
            for (int pos = startPosition; pos < endPostion; pos++) {
                FrameSet(pos, state);
            }
        }
